...
import 'package:trevashop_v2/Model/MenuItem.dart';
import 'package:trevashop_v2/Screen/B1_HomeScreen/HomeUIComponent/AppBar_Component/Search.dart';
              ...
              child: loadImage
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) =>
                          menuItemCard(itemDiscount[index]),
              ...
              child: Container(
                ...
                child: loadImage
                    ...
                    : ListView.builder(
                        scrollDirection: Axis.horizontal,
                        itemBuilder: (BuildContext context, int index) =>
                            menuItemCard(itemPopularData[index]),
                        itemCount: itemDiscount.length,
                      ),
              ),
            )
